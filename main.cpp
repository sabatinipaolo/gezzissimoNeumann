...
int main(){
    ...
    while (true){
        {    //FETCH
            ...
            ir = data_bus;  address_bus = -1 ; data_bus=-1; control_bus=' ';
        ...
        {     //DECODE
            cout<<endl << "DECODE di "<<ir<<" **********"<<endl<<endl;
            switch (ir)
            {
            case 11: 
                cout << " INC A"<<endl;
                cout << " incrementa il valore del registro A "<<endl<<endl;
                break;
            case 12: 
                cout << " DEC A"<<endl;
                cout << " decrementa il valore del registro A "<<endl<<endl;
                break;
            case 27: 
                cout << " ADD A , n " << endl;
                cout << " addiziona ad A il valore in memoria che segue immediatamente  l'istruzione"<<endl<<endl;
                break;
            case 0: 
                cout << " HLT " << endl;
                cout << " ferma il sistema "<<endl<<endl;
                break;
            default:
        ...
        {     //EXECUTE 
            ...
            case 27:
                ...
                a = a + data_bus;  address_bus = -1 ; data_bus=-1; control_bus=' ';
